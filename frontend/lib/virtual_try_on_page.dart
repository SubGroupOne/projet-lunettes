                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white.withOpacity(0.2), // Glassmorphismish
                          borderRadius: BorderRadius.circular(20),
                        ),
                         child: Row(
                            ...
                            children: List.generate(_styles.length, (index) {
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                                  decoration: BoxDecoration(
                                    color: isSelected ? const Color(0xFF4A90E2) : Colors.transparent, // Blue for selected
                                    borderRadius: BorderRadius.circular(20),
                                  ),
                                  child: Text(
                                    _styles[index],
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.check_box_outline_blank, color: Colors.white), // Placeholder for frame thumbnail
                      ),
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const ScannerOrdonnancePage()),
                            );
                          },
                          child: Container(
                            height: 100,
...
class GlassesGuidePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color(0xFF3F3F95).withOpacity(0.8) // Dark blueish purple
    ...
    path.quadraticBezierTo(
        size.width * 0.5, size.height * 0.4, size.width * 0.53, size.height / 2);
